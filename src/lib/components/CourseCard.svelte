<script lang="ts">
  ...
  // Reactive statements
  $: progress =
    userId && $userProgressStore ? $userProgressStore.get(course.id) : null;
  ...
  async function enrollInCourse() {
    ...
    try {
      await updateUserProgress(`${userId}-${course.id}`, {
        userId,
        courseId: course.id,
        status: "not_started",
        score: 0,
...
/** * Course Card Component * Phase 5B: Frontend Integration - Course Display *
* @description Composant Svelte pour afficher une carte de cours * @follows
MyDevFramework CoPilot Best Practices */
  ...
  {#if isEnrolled && progress}
    <div class="progress-section" data-testid="progress-section">
      <div class="progress-info">
        ...
        <span class="score" data-testid="course-score"
...
<style>
  ...
  .course-title-button:hover .course-title {
