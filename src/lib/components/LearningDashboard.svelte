...
<script lang="ts">
  ...
  import type { LearnerProfile } from "$lib/types/pedagogy";
...
<div class="learning-dashboard max-w-6xl mx-auto p-6 space-y-6">
  ...
  <div
    class="dashboard-header bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-xl p-6"
  >
    <div class="flex justify-between items-start">
      <div>
        <h1 class="text-2xl font-bold mb-2">Tableau de bord d'apprentissage</h1>
        <p class="text-blue-100">
          {currentProfile.demographics.grade_level} • Style dominant: {currentProfile
    ...
    <div class="metric-card bg-white rounded-lg p-4 shadow-sm border">
      <div class="flex items-center space-x-3">
        ...
        <div>
          <div class="metric-value text-xl font-bold text-gray-800">
            {Math.round(
              currentProfile.learning_analytics.improvement_rate * 100
            )}%
          </div>
  ...
  <div class="competences-section bg-white rounded-xl p-6 shadow-sm border">
    ...
    <div class="competences-grid space-y-4">
      {#each competences as [competenceId, competence]}
        <div
          class="competence-card border rounded-lg p-4 hover:shadow-md transition-shadow"
        >
          <div class="flex justify-between items-start mb-3">
            <div>
              ...
              <div class="flex items-center space-x-2 mt-1">
                <span
                  class="level-badge px-2 py-1 rounded-full text-xs font-medium {getMasteryColor(
            ...
            <div class="text-right">
              <div
                class="mastery-percentage text-2xl font-bold {getMasteryColor(
                  competence.mastery_percentage
                ).split(' ')[0]}"
              >
                {competence.mastery_percentage}%
          ...
          <div class="progress-bar bg-gray-200 rounded-full h-2 mb-3">
            <div
              ...
              class:bg-blue-500={competence.mastery_percentage >= 60 &&
                competence.mastery_percentage < 80}
              class:bg-yellow-500={competence.mastery_percentage >= 40 &&
                competence.mastery_percentage < 60}
          ...
          {#if showDetails}
            <div
              class="competence-details mt-4 pt-4 border-t border-gray-100"
              transition:slide
            >
  ...
  <div class="metacognition-section bg-white rounded-xl p-6 shadow-sm border">
    ...
    <div class="metacog-grid grid grid-cols-2 md:grid-cols-4 gap-4">
      <div class="metacog-skill text-center">
        <div
          class="skill-circle mx-auto w-16 h-16 rounded-full bg-blue-100 flex items-center justify-center mb-2"
        >
      ...
      <div class="metacog-skill text-center">
        <div
          class="skill-circle mx-auto w-16 h-16 rounded-full bg-green-100 flex items-center justify-center mb-2"
        >
      ...
      <div class="metacog-skill text-center">
        <div
          class="skill-circle mx-auto w-16 h-16 rounded-full bg-orange-100 flex items-center justify-center mb-2"
        >
      ...
      <div class="metacog-skill text-center">
        <div
          class="skill-circle mx-auto w-16 h-16 rounded-full bg-purple-100 flex items-center justify-center mb-2"
        >
    ...
    <div class="mt-4 p-4 bg-gray-50 rounded-lg">
      <div class="flex justify-between items-center text-sm">
        ...
        <span class="font-semibold"
          >{currentProfile.metacognitive_development
            .journal_entries_count}</span
        >
      </div>
      <div class="flex justify-between items-center text-sm mt-2">
        <span class="text-gray-600">Vocabulaire métacognitif:</span>
        <span class="font-semibold"
          >{currentProfile.metacognitive_development.metacognitive_vocabulary
            .length} mots</span
        >
      </div>
    </div>
  ...
  <div class="achievements-section bg-white rounded-xl p-6 shadow-sm border">
    ...
    <div class="achievements-grid grid grid-cols-1 md:grid-cols-3 gap-4">
      {#each recentAchievements as achievement}
        <div
          class="achievement-card border rounded-lg p-4 hover:shadow-md transition-shadow"
        >
  ...
  <div
    class="recommendations-section bg-gradient-to-r from-purple-50 to-blue-50 rounded-xl p-6 border"
  >
    <h2 class="text-xl font-bold text-gray-800 mb-4">
      💡 Recommandations personnalisées
    </h2>
    ...
    <div class="recommendations-list space-y-3">
      <div
        class="recommendation-item flex items-start space-x-3 p-3 bg-white rounded-lg"
      >
        <span class="text-xl">📚</span>
        <div>
          <h3 class="font-medium text-gray-800">Renforcer les mathématiques</h3>
          <p class="text-sm text-gray-600">
            Vos probabilités peuvent s'améliorer. Essayez les exercices
            interactifs.
          </p>
        </div>
      </div>
      ...
      >
        ...
        <div>
          ...
          <p class="text-sm text-gray-600">
            Votre métacognition progresse bien. Continuez vos réflexions
            quotidiennes.
          </p>
        </div>
      </div>
      ...
      >
        ...
        <div>
          ...
          <p class="text-sm text-gray-600">
            Vous êtes plus performant entre 14h-16h. Planifiez les tâches
