...
describe('Progress Tracking', () => {
  ...
  it('should handle phase completion', () => {
    ...
    const totalCurrent = phases.phase1.current + phases.phase2.current + phases.phase3.current;
    const totalMax = phases.phase1.total + phases.phase2.total + phases.phase3.total;
