...
<!-- Container principal -->
<div
  class="pre-evaluation-container max-w-4xl mx-auto p-6 bg-white rounded-xl shadow-lg"
>
  ...
  {#if isLoading}
    <!-- État de chargement -->
    <div
      class="loading-state flex items-center justify-center py-12"
      transition:fade
    >
  ...
  {:else if question}
    ...
    <div class="question-container" in:slide={{ duration: 300 }}>
      ...
      <div
        class="question-meta flex justify-between items-center mb-6 p-4 bg-gray-50 rounded-lg"
      >
        <div class="flex items-center space-x-4">
          <span
            class="difficulty-badge px-3 py-1 rounded-full text-sm font-medium
        ...
        <div class="timer flex items-center space-x-2">
          <svg
            class="w-5 h-5 {getTimerColor(timeRemaining)}"
            fill="currentColor"
            viewBox="0 0 20 20"
          >
            <path
        ...
        <div class="answers-container space-y-3">
          {#if isMultipleChoice && question.options}
            {#each question.options as option, index}
              <label
                class="answer-option flex items-center p-4 border-2 rounded-lg cursor-pointer transition-all
              ...
              >
                ...
                />
                <div
                  class="option-indicator w-5 h-5 border-2 rounded-full mr-3 flex items-center justify-center
      ...
      <div class="confidence-section mb-6">
        ...
        {#if showConfidenceSelector}
          <div
            class="confidence-selector mt-3 p-4 bg-gray-50 rounded-lg"
            transition:slide
          >
            ...
            <div class="confidence-options flex space-x-2">
              {#each [1, 2, 3, 4, 5] as level}
                <label class="confidence-option flex-1 text-center">
                  ...
                  />
                  <div
                    class="confidence-indicator p-2 border-2 rounded-lg cursor-pointer transition-all
										{confidence === level
