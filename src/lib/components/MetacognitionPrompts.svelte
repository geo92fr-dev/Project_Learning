...
<script lang="ts">
  ...
  export let trigger:
    ...
    | "after_lesson"
    | "after_exercise";
  export let userLevel: "beginner" | "intermediate" | "advanced" | "expert" =
    "intermediate";
...
{#if isVisible && prompt}
  ...
  >
    ...
    {#if !isExpanded}
      <button
        type="button"
        class="prompt-header flex items-center justify-between p-4 cursor-pointer hover:bg-gray-50 transition-colors w-full text-left"
      ...
      >
        ...
        <div class="flex items-center space-x-2">
          <span
            class="prompt-type px-2 py-1 rounded-full text-xs font-medium {getPromptTypeColor(
              prompt.type
            )}"
          >
            Réflexion
    ...
    {#if isExpanded}
      <div class="prompt-expanded" transition:fade={{ duration: 200 }}>
        <!-- Header expanded -->
        <div
          class="prompt-header-expanded flex items-center justify-between p-4 border-b border-gray-100"
        >
          <div class="flex items-center space-x-3">
            <div class="prompt-icon text-2xl">
              {getPromptTypeIcon(prompt.type)}
            ...
            <div>
              ...
              >
                {prompt.type === "self_assessment"
                  ? "Auto-évaluation"
                  : prompt.type === "reflection"
                  ? "Réflexion"
                  : prompt.type === "strategy"
                  ? "Stratégie"
                  : prompt.type === "monitoring"
                  ? "Monitoring"
        ...
        {#if showInsights}
          <div
            class="insights-panel p-4 bg-gray-50 border-b border-gray-100"
            transition:slide
          >
            <h5 class="text-sm font-medium text-gray-700 mb-2">
              Vos progrès métacognitifs
            </h5>
            <div class="insights-grid grid grid-cols-2 gap-2 text-xs">
              ...
              <div class="insight-item bg-white p-2 rounded">
                <div class="font-medium text-green-600">
                  {insights.averageDepth.toFixed(1)}/5
                </div>
              ...
              <div class="insight-item bg-white p-2 rounded">
                <div class="font-medium text-orange-600">
                  {insights.reflectionTrend.length > 0
                    ? insights.reflectionTrend[
                        insights.reflectionTrend.length - 1
                      ]
                    : 0}/5
                </div>
        ...
        <div class="prompt-question p-4">
          ...
          <div class="response-area">
            ...
            <div
              class="response-meta flex justify-between items-center mt-2 text-xs text-gray-500"
            >
          ...
          <div class="guidance-section mt-4">
            ...
            {#if showGuidance}
              <div
                class="guidance-content mt-2 p-3 bg-blue-50 rounded-lg text-sm text-blue-800"
                transition:slide
              >
                <p>{prompt.guidance}</p>
        ...
        <!-- Actions -->
        <div
          class="prompt-actions flex justify-between items-center p-4 bg-gray-50 rounded-b-xl"
        >
          <button
            on:click={skipPrompt}
