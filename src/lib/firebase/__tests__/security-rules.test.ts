    ...
    return {
      collection: (path: string) => ({
        doc: (id?: string) => ({
          ...
          set: async (data: any) => { /* Mock implementation */ },
          update: async (data: any) => { /* Mock implementation */ },
          delete: async () => { /* Mock implementation */ }
        })
      })
    };
  }
...
describe('Firebase Security Rules - TDD', () => {
  ...
  describe('Course Collection Rules', () => {
    describe('Read Access', () => {
      ...
      it('should deny access to unpublished courses for regular users', async () => {
        ...
        const unpublishedCourse = firestore.collection('courses').doc('draft123');
  ...
  describe('User Progress Collection Rules', () => {
    it('should allow users to read their own progress', async () => {
      ...
      const progressDoc = firestore.collection('userProgress').doc('user123-course456');
    ...
    it('should deny access to other users progress', async () => {
      ...
      const otherProgressDoc = firestore.collection('userProgress').doc('user456-course789');
