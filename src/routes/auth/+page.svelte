...
<svelte:head>
  ...
  <meta name="description" content="Connectez-vous à votre compte FunLearning pour accéder à vos cours et suivre votre progression." />
</svelte:head>
      ...
      {#if currentTab === 'google'}
        <div class="auth-method">
          <div class="method-description">
            ...
            <p>Utilisez votre compte Google pour vous connecter en un clic. Sécurisé et pratique.</p>
          </div>
