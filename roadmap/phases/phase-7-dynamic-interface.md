...
<style>
  ...
  /* ===== RADIUS VARIANTS ===== */
  .btn--radius-none { border-radius: var(--radius-none); }
...
<script lang="ts">
  ...
  export let learningStyle: 'visual' | 'auditory' | 'kinesthetic' | 'reading' = 'visual';
    ...
    <div class="learning-card__thumbnail">
      ...
      <div class="learning-card__overlay">
        ...
        <button
          ...
          aria-label={data.isBookmarked ? 'Retirer des favoris' : 'Ajouter aux favoris'}
        >
    ...
    {#if adaptive.showProgress}
      <div class="learning-card__progress-section">
        <div class="learning-card__progress-header">
          ...
          <span class="learning-card__progress-value">{progressPercentage}%</span>
        </div>
...
describe('Button Component', () => {
  ...
  describe('Icons', () => {
    ...
    it('should render right icon', () => {
      ...
      expect(rightIcon.querySelector('use')).toHaveAttribute('href', '#arrow-right');
    });
