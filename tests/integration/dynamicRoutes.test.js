  ...
  describe("📋 Navigation Flow Integration", () => {
    it("should support complete navigation hierarchy", async () => {
      ...
      const competenceData = {
        ...
        expectedTitle:
          "Calcul et opérations - 6ème Mathématiques - FunLearning",
      };
    ...
    it("should handle breadcrumb navigation correctly", () => {
      ...
      breadcrumbTests.forEach((test) => {
        ...
        expect(test.route.split("/").length - 2).toBe(
          test.expectedBreadcrumb.length - 1
        );
      });
    });
  });
  ...
  describe("🔍 Data Consistency Tests", () => {
        ...
        if (mockData) {
          ...
          if (
            ...
            competences.forEach((competence) => {
              const matiereExists = matieres.some(
                (m) => m.id === competence.matiereId
              );
              const niveauExists = niveaux.some(
                (n) => n.id === competence.niveauId
              );
    ...
    it("should validate route parameter format consistency", () => {
      const routeFormats = [
        ...
        {
          route: "/content/sciences/4eme/sciences-physique",
          params: ["sciences", "4eme", "sciences-physique"],
        },
      ];
  ...
  describe("⚡ Performance & Caching Tests", () => {
    ...
    it("should validate store state consistency during navigation", () => {
      ...
      const navigationSequence = [
        {
          action: "selectMatiere",
          param: "math",
          expectedState: { matiere: "math", niveau: null, competence: null },
        },
        {
          action: "selectNiveau",
          param: "6eme",
          expectedState: { matiere: "math", niveau: "6eme", competence: null },
        },
        {
          action: "selectCompetence",
          param: "math-calcul",
          expectedState: {
            matiere: "math",
            niveau: "6eme",
    ...
    it("should handle invalid route parameters gracefully", () => {
      ...
      invalidRoutes.forEach((route) => {
        ...
        if (parts.length < 2) {
          ...
          if (
            matiere.toUpperCase() === matiere ||
            matiere.includes("INVALID")
          ) {
            expect(true).toBe(true); // Should trigger 404
          }
        }
  ...
  describe("🎯 User Experience Tests", () => {
    it("should provide appropriate loading states", () => {
      const loadingStates = [
        ...
        {
          component: "compétence",
          expectedText: "Chargement de la compétence...",
        },
      ];
    ...
    it("should maintain proper meta tags for SEO", () => {
      const metaTests = [
        ...
        },
        {
          ...
          expectedTitle: "6ème Mathématiques - FunLearning",
          expectedDescription:
            "Compétences et cours de Mathématiques pour la 6ème",
        },
      ];
  ...
  describe("📋 Store Integration", () => {
    it("should sync route changes with store state", () => {
      ...
      const routeStateMapping = [
        {
          route: "/content/math",
          expectedStoreState: { currentMatiere: "math" },
        },
        {
          route: "/content/math/6eme",
          expectedStoreState: { currentMatiere: "math", currentNiveau: "6eme" },
        },
        {
          route: "/content/math/6eme/math-calcul",
          expectedStoreState: {
      ...
      routeStateMapping.forEach((mapping) => {
        ...
        if (routeParts.length >= 3) {
          expect(mapping.expectedStoreState.currentCompetence).toBe(
            routeParts[2]
          );
        }
      });
