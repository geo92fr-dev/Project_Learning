...
describe('Firebase Auth Configuration - TDD Approach', () => {
  ...
  describe('Configuration Validation', () => {
    ...
    it('should have valid auth domain', () => {
      const authDomain = process.env.VITE_FIREBASE_AUTH_DOMAIN || 'demo-project.firebaseapp.com';
  ...
  describe('Firebase Auth Functionality', () => {
    ...
    it('should handle auth operations correctly', async () => {
      ...
      const mockSignInWithPopup = vi.fn(() => Promise.resolve({
        user: {
          uid: 'test-uid',
  ...
  describe('Error Handling', () => {
    ...
    it('should provide helpful error messages', () => {
      const errorMessage = 'Firebase: Error (auth/api-key-not-valid.-please-pass-a-valid-api-key.)';
