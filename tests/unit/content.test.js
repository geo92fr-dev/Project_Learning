...
describe("Markdown Utils - Phase 3", () => {
  ...
  describe("generateSlug", () => {
    it("should create URL-friendly slugs", () => {
      ...
      expect(generateSlug("Introduction aux Sciences")).toBe(
  ...
  describe("hasUnsafeContent", () => {
    ...
    it("should detect dangerous tags", () => {
      ...
      expect(hasUnsafeContent('<object data="malicious.swf"></object>')).toBe(
        true
      );
    ...
    it("should not flag safe content", () => {
      ...
      expect(hasUnsafeContent('<a href="https://example.com">Link</a>')).toBe(
        false
      );
    });
  });
...
describe("Markdown Utils - Performance", () => {
  ...
  it("should generate slugs quickly for many titles", () => {
    const titles = Array.from(
      { length: 1000 },
      (_, i) => `Titre ${i} avec des accents é à ç`
    );
